...
To use Render Engine, you must have Python 3.11 or greater (supporting Python 3.11, 3.12, 3.13, 3.14, and 3.15)
installed. You can download Python from [python.org].
...
To use render-engine with the cli, you can install `render-engine-cli`. This would install both modules.
...
<table>
  <tbody>
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/arushiiii18"><img src="https://avatars.githubusercontent.com/u/191345547?v=4?s=57" width="57px;" alt="Arushi Sagar"/><br /><sub><b>Arushi Sagar</b></sub></a><br /><a href="https://github.com/render-engine/render-engine/commits?author=arushiiii18" title="Code">💻</a></td>
